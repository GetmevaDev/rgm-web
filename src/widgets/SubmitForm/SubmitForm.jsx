      ...
      {!isLoading ? (
        <form onSubmit={handleSubmit(sendEmail)} className={styles.form}>
          <div className={styles.inputs}>
            <Input label="Company Name" control={control} name="companyName" />

            <Input label="Domain Name" name="domain" control={control} />

            <Input control={control} label="Primary Contact Name" name="name" />
            ...
            <Input control={control} label="Budget Amount" name="budget" />
            ...
            <Input control={control} label="Project Overview" name="project" />
